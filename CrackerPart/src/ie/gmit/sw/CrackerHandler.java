...
import ie.gmit.sw.queues.RequestManager;
...
public class CrackerHandler extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String result = "Busy please wait..";
		String resultCheck = "Busy please wait..";
		...
		//this was encrypting the message before i put in the queue
		//then i decided to take it out so i can see if the queues are working
		/*try {
            ...
            out.print("ERROR ----FOR THE NAMING.LOOKUP");
        }*/
